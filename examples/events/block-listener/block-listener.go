...
func (a *adapter) GetInterestedEvents() ([]*pb.Interest, error) {
	return []*pb.Interest{{EventType: "block", ResponseType: pb.Interest_PROTOBUF}, {EventType: "rejection", ResponseType: pb.Interest_PROTOBUF}}, nil
}
...
func main() {
	...
	for {
		...
		case r := <-a.rejected:
			fmt.Printf("Received rejected transactions\n")
			fmt.Printf("--------------\n")
			for _, r := range r.Rejection.TransactionResults {
