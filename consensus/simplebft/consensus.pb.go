...
func (c *consensusClient) Consensus(ctx context.Context, in *Handshake, opts ...grpc.CallOption) (Consensus_ConsensusClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Consensus_serviceDesc.Streams[0], c.cc, "/simplebft.consensus/consensus", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *consensusConsensusClient) Recv() (*Msg, error) {
	m := new(Msg)
...
func (x *consensusConsensusServer) Send(m *Msg) error {
	return x.ServerStream.SendMsg(m)
}

var _Consensus_serviceDesc = grpc.ServiceDesc{
	ServiceName: "simplebft.consensus",
